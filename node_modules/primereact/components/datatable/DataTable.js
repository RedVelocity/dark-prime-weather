      ...
      if (this.columnWidthsState) {
        ...
        if (this.props.columnResizeMode === 'expand' && this.tableWidthState) {
          if (this.props.scrollable) {
            var scrollableBodyTable = _DomHandler.default.findSingle(this.container, '.p-datatable-scrollable-body-table');

            var scrollableHeaderTable = _DomHandler.default.findSingle(this.container, '.p-datatable-scrollable-header-table');

            var scrollableFooterTable = _DomHandler.default.findSingle(this.container, '.p-datatable-scrollable-footer-table');
