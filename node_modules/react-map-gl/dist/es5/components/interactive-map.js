...
function (_PureComponent) {
  ...
  function InteractiveMap(props) {
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)), "_controller", void 0);
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)), "_eventManager", void 0);
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)), "_interactiveContext", void 0);
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)), "_width", 0);
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)), "_height", 0);
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)), "_eventCanvasRef", (0, _react.createRef)());
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)), "_onLoad", function (event) {
      _this.setState({
        isLoaded: true
      });
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)), "_onClick", function (event) {
      ...
      var callbacks = [];
      var isDoubleClickEnabled = onDblClick || doubleClickZoom; // `click` is only fired on single click. `anyclick` is fired twice if double clicking.
    ...
    (0, _deprecateWarn.default)(props); // If props.controller is not provided, fallback to default MapController instance
  ...
  (0, _createClass2.default)(InteractiveMap, [{
    ...
    value: function componentDidMount() {
      ...
      eventManager.setElement(mapContainer); // Register additional event handlers for click and hover
