...
export default class GeolocateControl extends BaseControl {
  constructor(props) {
    ...
    _defineProperty(this, "_setupMapboxGeolocateControl", supportsGeolocation => {
      ...
      this._mapboxGeolocateControl = new mapboxgl.GeolocateControl(controlOptions); // the following re-implement MapboxGeolocateControl's _setupUI
      // replace mapbox internal prop

      this._mapboxGeolocateControl._watchState = 'OFF'; // replace mapbox internal UI elements

      this._mapboxGeolocateControl._geolocateButton = this._geolocateButtonRef.current; // replace mapbox internal methods
    ...
    _defineProperty(this, "_renderButton", (type, label, callback, children) => {
