...
function (_PureComponent) {
  ...
  function InteractiveMap(props) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "_interactiveContext", void 0);
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "_onLoad", function (event) {
      _this.setState({
        isLoaded: true
      });
